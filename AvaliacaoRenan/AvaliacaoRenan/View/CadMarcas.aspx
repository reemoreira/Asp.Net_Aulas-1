...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="input-group">
        <asp:Label ID="lblNome" class="control-label col-md-2" runat="server" Text="Nome" AssociatedControlID="txtnome"></asp:Label>
        <div class="col-md-10">
            <asp:TextBox ID="txtNome" class="form-group" runat="server"></asp:TextBox>
        </div>
    </div>
    <div class="input-group">
        <asp:Label ID="lblDescricao" class="control-label col-md-2" runat="server" Text="Descricao" AssociatedControlID="txtDescricao"></asp:Label>
        <div class="col-md-10">
            <asp:TextBox ID="txtDescricao" class="form-control" runat="server" Height="100px" TextMode="MultiLine" Width="197px"></asp:TextBox>
        </div>
    </div>
    <br>
    <div>
