...
namespace PlanoB.BO
{
    ...
    public class MSPDFFooter : PdfPageEventHelper //class  de roda pé
    {
        public string PageTitle { get; set; }
        public string PageSubTitle { get; set; }
        public string PageSubLogo { get; set; }
        ...
        private void ImprimeRodape(PdfWriter writer, Document doc)
        {
            ...
            if (ImprimirRodapePadrao)
            {
                ...
                #region Coluna TNE
                Image foot = Image.GetInstance(BasePath + @"\Util\rbm_mascote.png");
                ...
                cell = new PdfPCell(new Phrase("Rbm", negrito));
                cell.Border = 0;
                micros.AddCell(cell);
                cell = new PdfPCell(new Phrase("Rbm.corp", font));
                cell.Border = 0;
                micros.AddCell(cell);
                cell = new PdfPCell(new Phrase("www.Rbm.corporation.com.br", font));
                cell.Border = 0;
                micros.AddCell(cell);
